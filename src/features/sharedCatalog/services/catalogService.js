...
const normalizeMetalRate = (rate) => ({
  ...
  displayUnit: rate.displayUnit,
  displayCurrentPrice: rate.displayCurrentPrice === null ? null : Number(rate.displayCurrentPrice),
  displayPreviousPrice: rate.displayPreviousPrice === null ? null : Number(rate.displayPreviousPrice),
  displayChange: rate.displayChange === null ? null : Number(rate.displayChange),
